...
- [Cheptels selon la taille du troupeau par commune (Recensement agricole 2000 et 2010)](https://data.opendatasoft.com/explore/dataset/cheptels%40datacorsica/table/)
    - L'encodage des deux tables ont un encodage UTF-8 particulié (UTF-8 with BOM selon Visual Studio Code) donc on a utilisé Visual Studio Code pour réencoder dans le format UTF-8 standart pour régler les problèmes d'encodage dans le script R. Ces fichiers réencodés sont disponibles [ici](https://drive.google.com/file/d/1Hy-TajWp3s0kbFpUukYEd4NO9NADgHA0/view?usp=sharing)
